...
export const HUD = () => {
  const { currentWeapon, ammo, isReloading, playerHealth, maxPlayerHealth, isPlayerDead } = useGameStore();
  ...
  return (
    <>
      ...
      >
        ...
        <div style={{ width: '100%', backgroundColor: '#555', borderRadius: '3px', height: '10px' }}>
          <div
            style={{
